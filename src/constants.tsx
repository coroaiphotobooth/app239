...
export const DEFAULT_GAS_URL = 'https://script.google.com/macros/s/AKfycbz3MmbYwjMptuGNFKBa-EavqoVmVcUSiVn38jluwr5Knrtzx5u5Tn_6SrGpEw89ojDB/exec';
...
export const DEFAULT_SETTINGS: PhotoboothSettings = {
  ...
  monitorTheme: 'slider', // Default theme updated
